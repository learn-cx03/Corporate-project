...
export default function Test() {
  ...
  const [remove, setRemove] = useState('265')
...
//ChangeList 是通过函数还有传递过的index位置来对数组进行重新排序，从而实现点击的dom元素都在轮播图的中间的效果
  ...
  return (
    ...
    {/* 右边的箭头 */}
      <div onClick={ChangeNext} className="page_h"/>
    </div>
  )
}
